...
def create_success_response(message: str = "Success", data: Any = None) -> BaseResponse:
    return BaseResponse(status=StatusEnum.SUCCESS, message=message, data=data)


def create_error_response(
    message: str = "An error occurred", data: Any = None
) -> BaseResponse:
    return BaseResponse(status=StatusEnum.FAILED, message=message, data=data)


def create_warning_response(message: str = "Warning", data: Any = None) -> BaseResponse:
    return BaseResponse(status=StatusEnum.WARNING, message=message, data=data)
